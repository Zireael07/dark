...
// refer to Module (if they choose; they can also define Module)
  ...
  Module['FS_createPath']('/', 'assets', true, true);
   ...
   loadPackage({"files": [{"filename": "/assets/npcs.json", "start": 0, "end": 1916, "audio": 0}, {"filename": "/assets/terminal16x16.png", "start": 1916, "end": 10156, "audio": 0}], "remote_package_size": 10156, "package_uuid": "102ce2fb-9eed-4920-861a-92400f0fdd3d"});
...
var STACK_BASE = 5508528,
    STACKTOP = STACK_BASE,
    STACK_MAX = 265648,
    DYNAMIC_BASE = 5508528;
...
var ASM_CONSTS = {
 ...
 42704: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 42797: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 44022: function() {return screen.width;},  
 44049: function() {return screen.height;},  
 44077: function() {return window.innerWidth;},  
 44109: function() {return window.innerHeight;},  
 44187: function($0) {if (typeof setWindowTitle !== 'undefined') { setWindowTitle(UTF8ToString($0)); } return 0;},  
 44321: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 44487: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
 44713: function($0) {if(typeof(Module['SDL2']) === 'undefined') { Module['SDL2'] = {}; } var SDL2 = Module['SDL2']; if (!$0) { SDL2.audio = {}; } else { SDL2.capture = {}; } if (!SDL2.audioContext) { if (typeof(AudioContext) !== 'undefined') { SDL2.audioContext = new AudioContext(); } else if (typeof(webkitAudioContext) !== 'undefined') { SDL2.audioContext = new webkitAudioContext(); } if (SDL2.audioContext) { autoResumeAudioContext(SDL2.audioContext); } } return SDL2.audioContext === undefined ? -1 : 0;},  
 45266: function() {var SDL2 = Module['SDL2']; return SDL2.audioContext.sampleRate;},  
