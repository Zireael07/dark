...
// refer to Module (if they choose; they can also define Module)
  ...
  Module['FS_createPath']('/', 'assets', true, true);
   ...
   loadPackage({"files": [{"filename": "/assets/terminal16x16.png", "start": 0, "end": 8240, "audio": 0}], "remote_package_size": 8240, "package_uuid": "75f729ca-a987-4929-abb7-37d247caca12"});
...
var ASM_CONSTS = {
 ...
 1895: function() {FS.syncfs(true, function (err) { if (!err) { console.log("Successfully mounted and synced the filesystem"); ccall('game_load', 'v'); } });},  
